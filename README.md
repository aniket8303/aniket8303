...
const aniket = {
  ...
  currentFocus: "Improving Full-Stack skills & mastering DSA",
  funFact: "I enjoy turning ideas into real-world web applications 🚀",
};
```
...
| ------------------------------------------------ | ----------------------- | ---------- | ----------- |
| **PES Modern College of Engineering** | Bachelor of Engineering | ***8.27/10** | 🎓 Pursuing |
...
<div align="center">
  ...
  ![Bootstrap](https://img.shields.io/badge/Bootstrap_CSS-7952B3?style=for-the-badge&logo=bootstrap&logoColor=white)
...
| -------------------------------- | ------------ | -------------------------------------------------- |
| **Core Java**             | 🔥 Learning  | Building expertise in Core Java fundamentals |
| **Data Structures & Algorithms** | 📚 Studying  | Enhancing problem-solving skills                   |
| **Full Stack Development**       | 💪 Building | Full Stack Development Expertise                    |
